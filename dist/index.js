...
const FloatingChatWidget = (props) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: `fcw-bubble-container ${positionClass}`, style: { zIndex: config.zIndex } },
            isNagging && config.nagMessage && (React.createElement("div", { className: `fcw-nag-tooltip ${config.position === "bottom-left"
        ...
        React.createElement("div", { className: `fcw-chat-widget ${positionClass} ${isOpen ? "fcw-open" : "fcw-closed"}`, style: {
            ...
            React.createElement("div", { className: "fcw-chat-messages" },
                ...
                showPrompts &&
                    ...
                    config.suggestedPrompts.length > 0 && (React.createElement("div", { className: "fcw-suggested-prompts" }, config.suggestedPrompts.map((prompt, index) => (React.createElement("button", { key: index, className: "fcw-prompt-btn", onClick: () => handlePromptClick(prompt), type: "button" }, prompt))))),
